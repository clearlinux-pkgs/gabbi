...
Version  : 1.32.0
Release  : 56
URL      : http://pypi.debian.net/gabbi/gabbi-1.32.0.tar.gz
Source0  : http://pypi.debian.net/gabbi/gabbi-1.32.0.tar.gz
...
%prep
%setup -q -n gabbi-1.32.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487206236
